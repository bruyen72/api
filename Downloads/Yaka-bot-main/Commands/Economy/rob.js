...
module.exports = { 
    ...
    start: async ( 
        ...
        if (k > balance1.wallet) return Yaka.sendMessage(m.from, { text: '*☹️ You don\'t have enough money to pay fine incase you get caught*' }, { quoted: m }); 
        if (k > balance2.wallet) return Yaka.sendMessage(m.from, { text: '*Sorry, your victim is too poor 🤷🏽‍♂️ let go.*' }, { quoted: m }); 
